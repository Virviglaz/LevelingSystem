...
unsigned char 	RF_SendPayloadACK (char * data, unsigned char DataLen);
unsigned char   RF_Receive_Data(char * Data, unsigned char Dala_Len);

unsigned char   RF_Carrier_Detect(void);
unsigned char   RF_Count_Lost_Packets(void);
unsigned char   RF_Count_Resend_Packets(void);
